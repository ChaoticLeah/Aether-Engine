...
(function (mod) {
  ...
  var javascriptKeywords = (
    ...
    "if in import instanceof new null return super switch this throw true try typeof var void while with yield keyboard"
  ).split(" ");

  var objProps =
    "getComponent data incrementX incrementY incrementW incrementH setX setY setW setH getParentObjectId getX getY getW getH getComponent getFirstComponent removeComponent setSize setName addComponent".split(
      " "
    );
  ...
  function getCompletions(token, context, keywords, options) {
    ...
    function gatherCompletions(obj) {
      ...
      else if (obj instanceof Object) forEach(objProps, maybeAdd);
